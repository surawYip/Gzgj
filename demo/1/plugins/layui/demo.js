                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: '排序', title: '排序', width: '20%', align: 'center', resize: true },
                            { field: 'Hobby', title: '标题3', width: '20%', align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: '20%' }
                        ]
                    ]
                });
            }
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        ...
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 120, align: 'left', sort: true, resize: true, dataType: 'html' },
                            { field: '排序', title: '排序', width: 120, align: 'center', resize: true },
                            { field: 'Hobby', title: '标题3', minWidth: 100, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 150 },
                            {
                ...
                tableIns.on("expand", function (index, rowdata, $container) {
                    if (index % 2 === 0) {
                        ...
                        table.render({
                            ...
                            cols: [[
                                { field: 'Id', title: '编号', width: 50 },
                                { field: 'Name', title: '标题1', width: 120, align: 'left', dataType: 'html' },
                                { field: '排序', title: '排序', width: 120, align: 'center', resize: true },
                                { field: 'Hobby', title: '标题3', minWidth: 100, align: 'center', resize: true },
                                { field: 'Body', title: '标题5', width: 150 }
                            ]]
            ...
            function initTable12() {
                ...
                var tableIns = table.render({
                    ...
                    cols: [[
                        ...
                        { field: 'Name', title: '标题1', width: 150, align: 'left', sort: true, fixed: 'left' },
                        { field: '排序', title: '排序', width: 150, align: 'center', resize: true },
                        { field: 'Hobby', title: '标题3', width: 150, align: 'center', resize: true },
                        { field: 'Body', title: '标题5', width: 150 },
                        {
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 150, align: 'center', fixed: 'left' },
                            { field: '排序', title: '排序', minWidth: 100, align: 'center', sort: true, resize: true },
                            {
                                field: 'Sex', title: '标题2', width: 100, align: 'center', resize: true, formatter: function (data) {
                                    return data.Sex ? "男" : "女";
                                }
                            },
                            { field: 'Hobby', title: '标题3', width: 250, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 150, resize: true },
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 100, align: 'center', fixed: 'left' },
                            { field: '排序', title: '排序', minWidth: 100, align: 'center', sort: true, resize: true },
                            { field: 'Sex', title: '标题2', width: 100, align: 'center', resize: true },
                            { field: 'Hobby', title: '标题3', width: 250, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 150, resize: true },
                            { field: 'CreateTime', title: '时间', width: 165, sort: true },
                            {
            ...
            function initTable9() {
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            { field: 'Id', title: '编号', width: 60, fixed: 'left', sort: true },
                            { field: 'Name', title: '标题1', width: 120, align: 'center', fixed: 'left' },
                            { field: '排序', title: '排序', minWidth: 100, align: 'center', sort: true, resize: true },
                            { field: 'Sex', title: '标题2', width: 80, align: 'center', resize: true },
                            { field: 'Hobby', title: '标题3', width: 240, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 120, resize: true },
                            { field: 'CreateTime', title: '时间', width: 165, sort: true },
                            {
                                field: 'opts',
                                title: '操作',
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 120, align: 'center', fixed: 'left' },
                            { field: '排序', title: '排序', width: 150, align: 'center', resize: true },
                            { field: 'Sex', title: '标题2', width: 60, align: 'center' },
                            { field: 'Hobby', title: '标题3', minWidth: 240, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 120, resize: true },
                            {
                                field: 'opts',
                                title: '操作',
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            { field: 'Id', title: '编号', width: 60, fixed: 'left' },
                            {
                                field: 'Name', title: '标题1', width: 150, align: 'center', fixed: 'left', resize: true, islink: true, formatter: function (v) {
                                    return "<a target='_blank' href='http://www.baidu.com'>" + v + "，我是链接可以点击</a>";
                                }
                            },
                            { field: 'Hobby', title: '标题3', width: 150, align: 'center', resize: true },
                            { field: '排序', title: '排序', width: 150, align: 'center' },
                            { field: 'Sex', title: '标题2', width: 150, align: 'center' },
                            { field: 'Body', title: '标题5', width: 120, fixed: 'right' }
                        ]
                    ]
                });
            }
            ...
            function initTable6() {
                var tableIns = table.render({
                    ...
                    cols: [
                        ...
                        [
                            { field: 'Id', title: '编号', width: 60, fixed: 'left' },
                            { field: 'Name', title: '标题1', width: 150, align: 'center', fixed: 'left', resize: true },
                            { field: '排序', title: '排序', minWidth: 100, align: 'center', resize: true },
                            { field: 'Sex', title: '标题2', width: 50, align: 'center' },
                            { field: 'Hobby', title: '标题3', minWidth: 150, align: 'center' },
                            { field: 'Body', title: '标题5', width: 150, fixed: 'right', resize: true }
                        ]
                    ]
                });
            }
            ...
            function initTable5() {
                var tableIns = table.render({
                    ...
                    cols: [
                        ...
                        [
                            { field: 'Name', title: '标题1', width: 120, align: 'left', dataStyle: { color: "#159200" } },
                            {
                                field: '排序',
                                title: '排序',
                                align: 'left',
                            ...
                            { field: 'Hobby', title: '标题3', align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 120 }
                        ]
                    ]
                });
            }
            ...
            function initTable4() {
                var tableIns = table.render({
                    ...
                    cols: [[
                        ...
                        { field: 'Name', title: '标题1', width: 150 },
                        { field: '排序', title: '排序', width: 150, align: 'center' },
                        { field: 'Hobby', title: '标题3', minWidth: 100, align: 'center', resize: true, dataStyle: { color: '#159200' } },
                        { field: 'Body', title: '标题5', width: 150, fixed: 'right' }
                    ]]
                });
            }
            ...
            function initTable3() {
                var tableIns = table.render({
                    ...
                    cols: [[
                        ...
                        { field: 'Name', title: '标题1', align: 'left' },
                        { field: '排序', title: '排序', align: 'center', resize: true },
                        { field: 'Body', title: '标题5' }
                    ]]
                });
            }
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 100, align: 'left' },
                            { field: '排序', title: '排序', width: 150, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 150 }
                        ]
                    ]
                ...
                var tableIns = table.render({
                    ...
                    cols: [
                        [
                            ...
                            { field: 'Name', title: '标题1', width: 100, align: 'left' },
                            { field: '排序', title: '排序', width: 150, align: 'center', resize: true },
                            { field: 'Hobby', title: '标题3', minWidth: 150, align: 'center', resize: true },
                            { field: 'Body', title: '标题5', width: 150 }
                        ]
                    ]
                });
